...
var clinechart;
    nv.addGraph(function () {
        ...
        clinechart = nv.models.cumulativeLineChart()
    ...
    var stackedbarchart;
    nv.addGraph(function () {
        stackedbarchart = nv.models.multiBarChart().groupSpacing(0.1);
    ...
    $(".sidebar-toggle,.clickable.fa-chevron-up").on("click",function () {
        setTimeout(function () {
