...
document.addEventListener('click', function(e) {
  if (e.target.classList.contains('btnflip')) {
    ...
    var textarea = '<textarea style="width:100%; max-width:32em; height:12em; color:#777; resize: none">' + flipper.querySelector('p').innerText + '</textarea><br><button class="btn">Update</button>';
