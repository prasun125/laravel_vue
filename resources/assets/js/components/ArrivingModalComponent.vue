    ...
    <div class="modal d-flex flex-wrap j-c-center a-i-center">
        <div class="pickup-modal-content">
            <div class="d-flex j-c-end a-i-center">
                <button type="button" class="cur-point" @click="closeArrivingModal" data-dismiss="modal">&times;</button>
            </div>
            <div class="font-lato">
                ...
                <div class="min-width-100 width-100 max-width-100 d-flex flex-dir-row flex-wrap j-c-space-between a-i-center m-t-24 p-0-16">
                    <div class="pos-relative d-flex flex-dir-row j-c-space-between a-i-center pickup-input-container flex-grow-1 m-r-16">
                        ...
                        <input type="text" placeholder="Enter arriving address" style="flex-grow: 1;" class="font-lato font-size-14" v-model="arriving.address"/>
                    ...
                    <div class="pos-relative d-flex flex-dir-row j-c-space-between a-i-center pickup-input-container time-container">
                        ...
                        <input id="timepicker2" type="text" placeholder="Arrive by (optional)" style="flex-grow: 1;" class="font-lato font-size-14" v-model="arriving.time"/>
                        <i class="material-icons p-r-8 font-grey">
                            arrow_drop_down
                        </i>
                    </div>
                ...
                <div class="min-width-100 width-100 max-width-100 d-flex flex-dir-row flex-wrap a-i-center material-checkbox p-0-16 m-t-20 pos-relative">
                    ...
                    <textarea placeholder="Arriving note" rows="8" class="min-width-100 width-100 max-width-100 font-lato" style="resize: none; padding: 8px 36px;" v-model="arriving.note"></textarea>
                </div>
            </div>
            <div class="d-flex flex-wrap j-c-end a-i-center p-0-16">
                <button type="button" class="uppercase orange-button m-r-16" style="margin-top: 16px; margin-bottom: 16px;" @click="closeArrivingModal" data-dismiss="modal">
                    I'LL TELL YOU LATER
                </button>
                <button type="button" class="uppercase green-button" style="margin-top: 16px; margin-bottom: 16px;" @click="confirmArriving" data-dismiss="modal">
                    CONFIRM
                </button>
            </div>
        </div>
...
<script>
    export default {
        name: "ArrivingModalComponent",
        props: ['arrivingDetails', 'arrivingCityIndex'],
        data: function () {
            return {
	            arriving: this.arrivingDetails
            }
        },
        methods: {
            closeArrivingModal: function () {
                this.$root.$refs.createplan.arrivingModal = false;
                this.arriving.address = '';
                this.arriving.note = '';
                this.arriving.time = '';
            },
            confirmArriving: function () {
                this.$root.$refs.createplan.arrivingModal = false;
            }
        },
        mounted() {
            ...
            $(document).ready(function () {
                $('#timepicker2').timepicker({
                    ...
                    .on('show.timepicker', function (event) {
                        vmDeparting.arriving.time = event.time.value;
                    })
