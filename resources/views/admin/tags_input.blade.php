...
@section('header_styles')
    ...
    <link href="{{ asset('admin/assets/vendors/bootstrap-tagsinput/css/app.css') }}" rel="stylesheet">
    <link href="{{ asset('admin/assets/css/custom_css/tag_input.css') }}" rel="stylesheet" type="text/css" />
@stop
...
@section('footer_scripts')
    <script src="{{ asset('admin/assets/vendors/bootstrap-tagsinput/js/bootstrap-tagsinput.js') }}"></script>
    <script src="{{ asset('admin/assets/vendors/typeahead.js/js/typeahead.bundle.min.js') }}"></script>
    <script src="{{ asset('admin/assets/vendors/typeahead.js/js/bloodhound.min.js') }}"></script>
    <script src="{{ asset('admin/assets/js/tags_data/app_bs3.js') }}"></script>
@stop