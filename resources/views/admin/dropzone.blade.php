...
@section('header_styles')
    ...
    <link href="{{ asset('admin/assets/vendors/dropzone/css/dropzone.css') }}" rel="stylesheet" type="text/css" />
<style>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('admin/assets/vendors/dropzone/js/dropzone.js') }}" ></script>
    <script>
