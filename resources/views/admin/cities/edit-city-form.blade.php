					...
					<div class="panel-body">
						...
						<div class="position-center">
							...
							<form id="tryitForm" class="form-horizontal" method="POST"
							      action="{{ URL::to('admin/city/'. $data['city']['id'] . '/edit') }}">
								{{ csrf_field() }}
								<div class="cd-block">
									<div class="cd-content">
										<div class="form-group {{ $errors->first('city_name', 'has-error') }}">
											...
											<div class="col-lg-6">
												<input type="text" name="city_name"
												       ...
												       value="{{ $data['city']['city_name'] }}" required autofocus
												       autocomplete="on"/>
										...
										<div id="infowindow-content" style="height: 0;">
											<input type="hidden" id="place-id" name="place_id" value="@if($data['city']['city_name'] == $data['city']['nearest_address']){{ $data['city']['place_id'] }}@endif"><br>
										</div>
									</div>
								</div>
									...
									<div class="cd-block" id="nearest_city">
										<div class="cd-content">
											<div class="form-group {{ $errors->first('nearest_address', 'has-error') }}">
												<label class="col-lg-2 control-label" for="nearest_address">
													Nearest Address
												...
												<div class="col-lg-6">
													<input type="text" name="nearest_address"
													       ...
													       value="{{ $data['city']['nearest_address'] }}"/>
													{!! $errors->first('nearest_address', '<span class="help-block">:message</span>') !!}
												</div>
											</div>
											<div id="map2"></div>
											<div id="infowindow-content2" style="height: 0;">
												<input type="hidden" id="nearest_address_place-id" name="nearest_address_place_id" value="@if($data['city']['city_name'] != $data['city']['nearest_address']){{ $data['city']['place_id'] }}@endif"><br>
											</div>
										</div>
									</div>
								<div class="form-group">
									...
									<div class="col-md-6">
										<div class="radio">
											<label>
												<input type="checkbox" name="suggested_destination" id="attraction" @if(isset($data['city']['suggested_destination']) AND $data['city']['suggested_destination'] != 0) checked @endif>
											</label>
										</div>
									</div>
								</div>
										...
										<div class="form-group {{ $errors->first('priority', 'has-error') }}">
											...
											<div class="col-lg-6">
												<input type="number" name="priority"
												       ...
												       @if(isset($data['city']['priority'])) value="{{ $data['city']['priority'] }}" @endif/>
								...
								<div class="cd-block">
									<div class="cd-content">
										<div class="form-group">
											...
											<div class="col-lg-6">
												<textarea id="description" name="description" rows="7" class="form-control resize_vertical" placeholder="Enter your message" data-bv-field="message">
