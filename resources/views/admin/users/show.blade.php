...
@section('header_styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/css/custom_css/profile.css') }}" />
@stop
                    ...
                    <div class="panel-body">
                        <div class="col-md-4">
                            ...
                            <div align="center">
                                ...
                                <p>{!! $user->email !!}</p>
                                <img src="{{ asset('admin/assets/img/flaticons/social-media-09.png') }}" alt="Picture" width="30" height="30">
                                <img src="{{ asset('admin/assets/img/flaticons/social-media-16.png') }}" alt="Picture" width="30" height="30">
                                <img src="{{ asset('admin/assets/img/flaticons/social-media-07.png') }}" alt="Picture" width="30" height="30">
                            </div>
                            &nbsp;&nbsp;
                            <div align="center">
                        ...
                        <div class="activity">
                            <div class="imgs-profile">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-circle" src="{{ asset('admin/assets/img/authors/avatar.jpg') }}" alt=""></a>
                            ...
                            <div class="imgs-profile">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-circle" src="{{ asset('admin/assets/img/authors/avatar1.jpg') }}" alt=""></a>
                                <div class="media-body">
                                    ...
                                    <div class="media blog-media">
                                        <a class="pull-left" href="#">
                                            <img class="media-object thumbnail" src="{{ asset('admin/assets/img/authors/avatar2.jpg') }}" alt=""></a>
                            ...
                            <div class="imgs-profile">
                                <a class="pull-left" href="#">
                                    <img class="media-object" src="{{ asset('admin/assets/img/authors/avatar3.jpg') }}" alt=""></a>
                                <div class="media-body">
                            ...
                            <div class="imgs-profile">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-circle" src="{{ asset('admin/assets/img/authors/avatar4.jpg') }}" alt=""></a>
                                <div class="media-body">
                                    ...
                                    <ul class="uploadphoto-list">
                                        <li>
                                            <a href="{{ asset('admin/assets/img/authors/avatar1.jpg') }}" data-rel="prettyPhoto">
                                                <img src="{{ asset('admin/assets/img/authors/avatar1.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('admin/assets/img/authors/avatar4.jpg') }}" data-rel="prettyPhoto">
                                                <img src="{{ asset('admin/assets/img/authors/avatar4.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('admin/assets/img/authors/avatar5.jpg') }}" data-rel="prettyPhoto">
                                                <img src="{{ asset('admin/assets/img/authors/avatar5.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="imgs-profile">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-circle" src="{{ asset('admin/assets/img/authors/avatar7.jpg') }}" alt=""></a>
                                <div class="media-body">
                            ...
                            <div class="imgs-profile">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-circle" src="{{ asset('admin/assets/img/authors/avatar2.jpg') }}" alt=""></a>
                                <div class="media-body">
                                    <strong>Lenny</strong>
                                    posted a new note.
                                    <br>
                            ...
                            <div class="imgs-profile">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-circle" src="{{ asset('admin/assets/img/authors/avatar3.jpg') }}" alt=""></a>
                                <div class="media-body">
                                    ...
                                    <div class="media blog-media">
                                        <a class="pull-left" href="#">
                                            <img class="media-object thumbnail" src="{{ asset('admin/assets/img/authors/avatar4.jpg') }}" alt=""></a>
                                        <div class="media-body col-md-8 col-lg-8 col-sm-8 col-xs-12">
                                            <h4 class="media-title">
                            ...
                            <div class="imgs-profile">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="mb20"></div>
                                    <a href="{{ asset('admin/assets/img/authors/avatar.jpg') }}" data-rel="prettyPhoto" class="img-single img-responsive" style="width:300px;">
                                        <img src="{{ asset('admin/assets/img/authors/avatar.jpg') }}" class="thumbnail img-responsive" alt="" width="200px" height="200px"></a>
                                </div>
                            </div>
                            <!-- media -->
